...
<div id="outer">
    <header class="header order-last" id="tm-header">
        <nav class="navbar">
            <div class="collapse navbar-collapse single-page-nav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="#section-1"><span class="icn"><em
                                        class="fas fa-2x fa-air-freshener"></em></span>Our Company</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#section-2"><span class="icn"><em
                                        class="fab fa-2x fa-battle-net"></em></span>Our Work</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#section-3"><span class="icn"><em
                                        class="far fa-2x fa-images"></em></span>Gallery</a>
                    </li>
                    <li class="nav-item">
    ...
    <main id="content-box" class="order-first">
        <div class="banner-section section parallax-window" data-parallax="scroll" data-image-src="img/section-1-bg.jpg"
             id="section-1">
            <div class="container">
                <div class="item">
                    <div class="bg-blue-transparent logo-fa"><span><em class="fas fa-2x fa-atom"></em></span>De
                        Keukenboer
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="item col-md-4 two">
                        <div class="tm-work-item-inner">
                            ...
                            <h3>3 Uitvoering</h3>
                            <p>Na uw goedkeuring starten wij met de uitvoering. Uiteraard wordt de keuken ter plekke
                                geïnstalleerd.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 mb-4 contact-form">
                        <div class="form tm-contact-item-inner">
                            <form action="handlemessage.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label><input name="email" type="text" class="form-control"
                                                  placeholder="Email"></label>
                                </div>
                                <div class="form-group">
                                    <label><textarea name="message" class="textarea form-control"
